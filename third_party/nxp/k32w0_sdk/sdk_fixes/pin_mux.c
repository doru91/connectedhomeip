...
#ifdef LUMI_DOORLOCK
   IOCON_PinMuxSet(IOCON,0,12,IOCON_FUNC5|IOCON_DIGITAL_EN|IOCON_STDI2C_EN);//I2C1_SCL
   IOCON_PinMuxSet(IOCON,0,13,IOCON_FUNC5|IOCON_DIGITAL_EN|IOCON_STDI2C_EN);//I2C1_SDA
   GPIO_PortInit(GPIO, 0);
#endif

#ifdef LUMI_OCCUPANCYSENSOR
    IOCON_PinMuxSet(IOCON,0,BOARD_OCCUPANCY_SENSOR_PWR_PIN,   IOCON_FUNC0|IOCON_DIGITAL_EN|IOCON_MODE_INACT|IOCON_IO_CLAMPING_NORMAL_MFIO);
    IOCON_PinMuxSet(IOCON,0,BOARD_OCCUPANCY_SENSOR_CTRL_L_PIN,IOCON_FUNC0|IOCON_DIGITAL_EN|IOCON_MODE_INACT|IOCON_IO_CLAMPING_NORMAL_MFIO);
    IOCON_PinMuxSet(IOCON,0,BOARD_OCCUPANCY_SENSOR_CTRL_M_PIN,IOCON_FUNC0|IOCON_DIGITAL_EN|IOCON_MODE_INACT|IOCON_IO_CLAMPING_NORMAL_MFIO);
    IOCON_PinMuxSet(IOCON,0,BOARD_OCCUPANCY_SENSOR_CTRL_H_PIN,IOCON_FUNC0|IOCON_DIGITAL_EN|IOCON_MODE_INACT|IOCON_IO_CLAMPING_NORMAL_MFIO);
    IOCON_PinMuxSet(IOCON,0,BOARD_OCCUPANCY_SENSOR_DET1_PIN,  IOCON_FUNC0|IOCON_DIGITAL_EN|IOCON_MODE_PULLUP);
    IOCON_PinMuxSet(IOCON,0,BOARD_OCCUPANCY_SENSOR_DET2_PIN,  IOCON_FUNC0|IOCON_DIGITAL_EN|IOCON_MODE_PULLUP);
   /* Define the init structure for the occupancy sensor ctrl output pin*/
    gpio_pin_config_t sensor_config = {
        kGPIO_DigitalOutput,
        1,
    };

    /* Init output sensor ctrl*/
    GPIO_PortInit(GPIO, 0);
    GPIO_PinInit(GPIO, 0, BOARD_OCCUPANCY_SENSOR_PWR_PIN, &sensor_config);
    GPIO_PinInit(GPIO, 0, BOARD_OCCUPANCY_SENSOR_CTRL_L_PIN, &sensor_config);
    GPIO_PinInit(GPIO, 0, BOARD_OCCUPANCY_SENSOR_CTRL_M_PIN, &sensor_config);
    GPIO_PinInit(GPIO, 0, BOARD_OCCUPANCY_SENSOR_CTRL_H_PIN, &sensor_config);
#endif
}
