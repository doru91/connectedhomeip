...
class JointFabricDatastoreCluster(private val controller: MatterController, private val endpointId: UShort) {class GroupKeyListAttribute(
    val value: List<JointFabricDatastoreClusterGroupKeySetStruct>
  )
...
class StatusEntryAttribute(
    val value: List<JointFabricDatastoreClusterDatastoreStatusEntry>
  )
...
class NodeKeySetListAttribute(
    val value: List<JointFabricDatastoreClusterDatastoreNodeKeyEntry>
  )
...
class NodeAclListAttribute(
    val value: List<JointFabricDatastoreClusterDatastoreACLEntry>
  )
...
class AttributeListAttribute(
  ...
  suspend fun addKeySet(groupKeySet: JointFabricDatastoreClusterGroupKeySetStruct
  ...
  suspend fun updateKeySet(groupKeySet: JointFabricDatastoreClusterGroupKeySetStruct
      ,timedInvokeTimeout: Duration? = null) {
  ...
  suspend fun addAdmin(adminInformationEntry: JointFabricDatastoreClusterDatastoreAdministratorInformationEntry?
      ,timedInvokeTimeout: Duration? = null) {
...
suspend fun readGroupKeyListAttribute(): GroupKeyListAttribute {val ATTRIBUTE_ID: UInt = 4u
    ...
    requireNotNull(attributeData) { 
      "Groupkeylist attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<JointFabricDatastoreClusterGroupKeySetStruct> = buildList<JointFabricDatastoreClusterGroupKeySetStruct> {
  ...
  suspend fun subscribeGroupKeyListAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(GroupKeyListAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Groupkeylist attribute not found in Node State update" 
          }
...
suspend fun readGroupListAttribute(): GroupListAttribute {val ATTRIBUTE_ID: UInt = 5u
    ...
    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<JointFabricDatastoreClusterDatastoreGroupInformationEntry> = buildList<JointFabricDatastoreClusterDatastoreGroupInformationEntry> {
      tlvReader.enterArray(AnonymousTag)
      while(!tlvReader.isEndOfContainer()) {
        add(JointFabricDatastoreClusterDatastoreGroupInformationEntry.fromTlv(AnonymousTag, tlvReader))
      }
      tlvReader.exitContainer()
    }
...
suspend fun readNodeListAttribute(): NodeListAttribute {val ATTRIBUTE_ID: UInt = 6u
    ...
    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<JointFabricDatastoreClusterDatastoreNodeInformationEntry> = buildList<JointFabricDatastoreClusterDatastoreNodeInformationEntry> {
      tlvReader.enterArray(AnonymousTag)
      while(!tlvReader.isEndOfContainer()) {
        add(JointFabricDatastoreClusterDatastoreNodeInformationEntry.fromTlv(AnonymousTag, tlvReader))
      }
      tlvReader.exitContainer()
    }
...
suspend fun readAdminListAttribute(): AdminListAttribute {val ATTRIBUTE_ID: UInt = 7u
    ...
    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<JointFabricDatastoreClusterDatastoreAdministratorInformationEntry> = buildList<JointFabricDatastoreClusterDatastoreAdministratorInformationEntry> {
      tlvReader.enterArray(AnonymousTag)
      while(!tlvReader.isEndOfContainer()) {
        add(JointFabricDatastoreClusterDatastoreAdministratorInformationEntry.fromTlv(AnonymousTag, tlvReader))
      }
      tlvReader.exitContainer()
    }
...
suspend fun readStatusEntryAttribute(): StatusEntryAttribute {val ATTRIBUTE_ID: UInt = 8u
    ...
    requireNotNull(attributeData) { 
      "Statusentry attribute not found in response" 
    }

    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<JointFabricDatastoreClusterDatastoreStatusEntry> = buildList<JointFabricDatastoreClusterDatastoreStatusEntry> {
      tlvReader.enterArray(AnonymousTag)
      while(!tlvReader.isEndOfContainer()) {
        add(JointFabricDatastoreClusterDatastoreStatusEntry.fromTlv(AnonymousTag, tlvReader))
      }
      tlvReader.exitContainer()
    }
  ...
  suspend fun subscribeStatusEntryAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(StatusEntryAttributeSubscriptionState.Error(Exception("Subscription terminated with error code: ${subscriptionState.terminationCause}")))
        }
        is SubscriptionState.NodeStateUpdate -> {
          val attributeData =
            subscriptionState.updateState.successes.filterIsInstance<ReadData.Attribute>().firstOrNull {
          ...
          requireNotNull(attributeData) { 
            "Statusentry attribute not found in Node State update" 
          }
...
suspend fun readEndpointGroupIdListAttribute(): EndpointGroupIdListAttribute {val ATTRIBUTE_ID: UInt = 9u
    ...
    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<JointFabricDatastoreClusterDatastoreEndpointGroupIDEntry> = buildList<JointFabricDatastoreClusterDatastoreEndpointGroupIDEntry> {
      tlvReader.enterArray(AnonymousTag)
      while(!tlvReader.isEndOfContainer()) {
        add(JointFabricDatastoreClusterDatastoreEndpointGroupIDEntry.fromTlv(AnonymousTag, tlvReader))
      }
      tlvReader.exitContainer()
    }
...
suspend fun readEndpointBindingListAttribute(): EndpointBindingListAttribute {val ATTRIBUTE_ID: UInt = 10u
    ...
    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<JointFabricDatastoreClusterDatastoreEndpointBindingEntry> = buildList<JointFabricDatastoreClusterDatastoreEndpointBindingEntry> {
      tlvReader.enterArray(AnonymousTag)
      while(!tlvReader.isEndOfContainer()) {
        add(JointFabricDatastoreClusterDatastoreEndpointBindingEntry.fromTlv(AnonymousTag, tlvReader))
      }
      tlvReader.exitContainer()
    }
...
suspend fun readNodeKeySetListAttribute(): NodeKeySetListAttribute {val ATTRIBUTE_ID: UInt = 11u
    ...
    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<JointFabricDatastoreClusterDatastoreNodeKeyEntry> = buildList<JointFabricDatastoreClusterDatastoreNodeKeyEntry> {
      tlvReader.enterArray(AnonymousTag)
      while(!tlvReader.isEndOfContainer()) {
...
suspend fun readNodeAclListAttribute(): NodeAclListAttribute {val ATTRIBUTE_ID: UInt = 12u
    ...
    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<JointFabricDatastoreClusterDatastoreACLEntry> = buildList<JointFabricDatastoreClusterDatastoreACLEntry> {
      tlvReader.enterArray(AnonymousTag)
      while(!tlvReader.isEndOfContainer()) {
...
suspend fun readNodeEndpointListAttribute(): NodeEndpointListAttribute {val ATTRIBUTE_ID: UInt = 13u
    ...
    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: List<JointFabricDatastoreClusterDatastoreEndpointEntry> = buildList<JointFabricDatastoreClusterDatastoreEndpointEntry> {
      tlvReader.enterArray(AnonymousTag)
      while(!tlvReader.isEndOfContainer()) {
