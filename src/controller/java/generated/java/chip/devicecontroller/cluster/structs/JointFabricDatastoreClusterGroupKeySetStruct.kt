...
class JointFabricDatastoreClusterGroupKeySetStruct (
  ...
  companion object {
    ...
    fun fromTlv(tlvTag: Tag, tlvReader: TlvReader) : JointFabricDatastoreClusterGroupKeySetStruct {
      ...
      return JointFabricDatastoreClusterGroupKeySetStruct(groupKeySetID, groupKeySecurityPolicy, epochKey0, epochStartTime0, epochKey1, epochStartTime1, epochKey2, epochStartTime2)
    }
  }
}
